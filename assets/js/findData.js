...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var findReferenceNumber = document.querySelector("#findReferenceNumber");
    var findTechnician = document.querySelector("#findTechnician");
    var findHandler = document.querySelector("#findHandler");
    var findHardwareParts = document.querySelector("#findHardwareParts");
    ...
    var findSONumber = document.querySelector("#findSONumber");
        ...
        get(child(dbref, "Data/" + findCaseIDInput.value))
            .then((snapshot) => {
                if (snapshot.exists()) {
                    ...
                    findReferenceNumber.textContent = data.ReferenceNumber || "";
                    findTechnician.textContent = data.TechnicianName || "";
                    findHandler.textContent = data.HandlerName || "";
                    findHardwareParts.textContent = data.HardwareParts || "";
                    ...
                    findSONumber.textContent = data.SONumber || "";
